...
#define ALLTOALL_PIVOT_SLICESTEPS_SINGLE_NODE (NCCL_STEPS/2)
...
static_assert(ALLTOALL_PIVOT_SLICESTEPS_SINGLE_NODE == ALLTOALL_PIVOT_CHUNKSTEPS, "ALLTOALL_PIVOT_SLICESTEPS_SINGLE_NODE must be equal to ALLTOALL_PIVOT_CHUNKSTEPS");
