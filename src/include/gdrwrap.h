...
static ncclResult_t ncclGdrCudaCalloc(T** ptr, T** devPtr, size_t nelem, void** gdrHandle, hipStream_t stream) {
  // gdr_info_t info; // unused variable - compiler waring
  size_t mapSize;
  // gdr_mh_t mh;     // unused variable - compiler waring
  char *devMem;
  // void *gdrMap;    // unused variable - compiler waring
...
static ncclResult_t ncclGdrCudaCopy(void *gdrHandle, T* dst, T* src, size_t nelem) {
  //gdr_mem_desc_t *md = (gdr_mem_desc_t*)gdrHandle; // unused variable - compiler waring
