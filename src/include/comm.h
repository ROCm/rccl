...
struct ncclComm {
  ...
  uint64_t minMaxChannelThresholds[RCCL_TUNABLE_COLLS][5][3]; //for each collective, set for 5 channel-counts: 32,40,48,56,64, the two values for min/max size-threshold 
