...
* Adding ability to choose unroll factor at runtime via `RCCL_UNROLL_FACTOR`.  This can be set at runtime to 1, 2 or 4.  This change currently increases compilation and linking time due to triple the number of kernels generated.
