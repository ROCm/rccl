...
* Added support for rail-optimized tree algorithm for MI300 series.  Requires the use of all eight GPUs within
  each node.  This limits NIC traffic to only GPUs of the same index across nodes and should not impact performance
