...
- Changing CMake exported target name from rccl to roc::rccl, similarly to the other ROCm
  components. Users should now be able to link their targets against RCCL_LIBRARY.
