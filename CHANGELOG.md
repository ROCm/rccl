...
* Added MSCCL support for AllGather multinode gfx942/gfx950 (i.e., 16, 32 and 64 GPUs). To enable, set the environment variable `RCCL_MSCCL_FORCE_ENABLE=1`. Max message size for MSCCL AllGather usage is `12292 * sizeof(datatype) * nGPUs`.
