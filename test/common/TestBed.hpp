...
namespace RcclUnitTesting
{
  ...
  public:
    ...
    bool                       blockingConf;          // RCCL communication with blocking or non-blocking option
    ...
    void InitComms(std::vector<std::vector<int>> const& deviceIdsPerChild, int const numCollectivesInGroup = 1, bool const blockingConf = true);
    // Prepare TestBed for use with GPUs on a single child process
    void InitComms(int const numGpus, int const numCollectivesInGroup = 1, bool const blockingConf = true);
