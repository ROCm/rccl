...
def runTestCommand (platform, project)
{
    ...
    def command = """#!/usr/bin/env bash
                ...
                ${sudo} NCCL_DEBUG=INFO HSA_FORCE_FINE_GRAIN_PCIE=1 ./UnitTestsMultiProcess --gtest_filter="BroadcastMultiProcessCorrectnessSweep*:*float32*:-CombinedCallsMultiProcess*" --gtest_output=xml --gtest_color=yes
            """
