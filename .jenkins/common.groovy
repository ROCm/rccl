...
def runTestCommand (platform, project, gfilter, envars)
{
    ...
    def command = """#!/usr/bin/env bash
                ...
                ulimit -a
                ${sudo} ${envars} HSA_XNACK=1 RCCL_ENABLE_SIGNALHANDLER=1 NCCL_DEBUG=INFO HSA_FORCE_FINE_GRAIN_PCIE=1 ./rccl-UnitTests --gtest_filter=${gfilter} --gtest_output=xml --gtest_color=yes
            """
