...
def runTestCommand (platform, project, gfilter)
{
    ...
    def command = """#!/usr/bin/env bash
                ...
                ulimit -a
                ${sudo} AMD_LOG_LEVEL=3 RCCL_ENABLE_SIGNALHANDLER=0 NCCL_DEBUG=INFO HSA_FORCE_FINE_GRAIN_PCIE=1 ./rccl-UnitTests --gtest_filter=${gfilter} --gtest_output=xml --gtest_color=yes
            """
