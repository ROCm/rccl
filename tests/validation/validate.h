...
template<typename T>
inline bool validate(T* ptr, T val, size_t len, size_t tail=1, size_t offset=0);

template<typename T>
inline bool validate(T* got, T* expected, size_t len, size_t tail=1, size_t offset=0);
...
template<typename T>
inline bool validate(T* got, T* expected, size_t len, size_t tail, size_t offset) {
    size_t i = offset;
    size_t tailIter = 0;
    while(i<len) {
